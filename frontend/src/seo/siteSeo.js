/** Configuración SEO central (producción: skinatlas.es). */
export const SITE_SEO = {
  name: 'SkinAtlas',
  titleSuffix: 'SkinAtlas',
  url: 'https://skinatlas.es',
  locale: 'es_ES',
  language: 'es',
  defaultTitle: 'SkinAtlas | Comparador de precios de skins CS2',
  defaultDescription:
  ...
  defaultKeywords:
    'CS2 skins, precios skins CS2, comparador skins, Counter-Strike 2, Steam market, Skinport, DMarket',
  themeColor: '#0a0c10',
...
const PUBLIC_ROUTES = {
  ...
  '/suscripciones': {
    ...
    description:
      'Planes y herramientas premium de SkinAtlas: alertas, CSBot y funciones para traders de skins CS2.',
  },
  '/aviso-legal': {
    title: 'Aviso legal',
    description: 'Información legal y datos del titular del sitio SkinAtlas.',
    noindex: false,
  },
  '/privacidad': {
    title: 'Política de privacidad',
    description: 'Cómo tratamos tus datos personales en SkinAtlas (RGPD).',
  },
  '/cookies': {
    title: 'Política de cookies',
    description: 'Uso de cookies y publicidad en SkinAtlas.',
  },
  '/terminos': {
    title: 'Términos y condiciones',
    description: 'Condiciones de uso del comparador SkinAtlas.',
  },
  '/contacto': {
    title: 'Contacto',
    description: 'Contacta con el equipo de SkinAtlas: soporte y patrocinios.',
  },
};
...
export function buildOrganizationJsonLd() {
  return {
    ...
    name: SITE_SEO.name,
    url: SITE_SEO.url,
    email: 'jllorenspadilla@gmail.com',
  };
}
